...
class Settings(BaseSettings):
    ...
    HF_API_BASE: str = Field(
        ...
        description="Hugging Face router base URL for Inference Providers (OpenAI-compatible for chats)."
    )
    ...
    LLM_MODEL: str = Field(
        ...
        description="LLM model used for generating answers"
    )
    ...
    ALLOWED_ORIGINS: List[str] = ["https://foolish-bookings-179959.framer.app/"]  #  Framer domain
...
# Created a global settings instance that can be accessed everywhere
settings = Settings()
